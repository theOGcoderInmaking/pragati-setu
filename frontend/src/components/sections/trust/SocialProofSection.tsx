...
const SocialProofSection: React.FC = () => (
    <section className="relative w-full py-32 bg-[#060A12] overflow-hidden">
        <div className="max-w-[1280px] mx-auto px-6">
            ...
            <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 mb-20">
                {CARDS.map((card, i) => (
            ...
            <div className="flex justify-center">
                <Link href="/reviews">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="px-10 py-4 glass-card border-white/10 hover:border-saffron/40 text-text-primary font-sans font-semibold transition-all group"
                    >
                        View All Verified Reviews
                        <span className="ml-3 text-saffron opacity-60 group-hover:opacity-100 transition-opacity">→</span>
                    </motion.button>
                </Link>
            </div>
        </div>
